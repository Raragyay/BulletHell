...
class TextInput:
    ...
    def __init__(self, initial_string="",
                 ...
                 max_length=sys.maxsize, valid_keys=string.ascii_lowercase+string.ascii_uppercase):
        """
    ...
    def update(self, events: List[pygame.event.Event]) -> bool:
        ...
        for event in events:
            if event.type == pygame.KEYDOWN:
                ...
                if event.key not in self.keyrepeat_counters and pygame.key.name(event.key) in self.valid_keys:
